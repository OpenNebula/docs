...
extensions = ['sphinx.ext.graphviz', 'sphinx.ext.todo','versions','sphinx-prompt', 'sphinx_substitution_extensions']
...
project = 'OpenNebula'
copyright = '2022, OpenNebula Team <contact@opennebula.io>'
...
rst_prolog = " .. |version| replace:: {version} ".format(version=release)
