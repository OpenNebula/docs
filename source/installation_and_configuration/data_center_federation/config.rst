...
.. important:: The federation can be setup with MySQL/MariaDB or SQLite backends, but you cannot mix them across zones. MySQL/MariaDB is recommended for production deployments.
