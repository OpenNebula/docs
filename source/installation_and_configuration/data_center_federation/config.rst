...
.. important:: The federation can be set-up with MySQL or SQLite backends, but you can't mix them across Zones. MySQL is recommended for production deployments.
