...
.. prompt:: bash # auto
    ...
    # docker pull enterprise.opennebula.io/opennebula:6.1.90
...
.. prompt:: bash # auto
    ...
    # docker pull docker.io/opennebula/opennebula:6.1.90
...
.. prompt:: bash # auto
    ...
    # wget --user=XXXX --ask-password https://enterprise.opennebula.io/packages/opennebula-6.1.90/container/docker-compose-opennebula.tar.gz
...
.. prompt:: bash # auto
    ...
    # wget https://downloads.opennebula.io/packages/opennebula-6.1.90/container/docker-compose-opennebula.tar.gz
    # tar -xvf docker-compose-opennebula.tar.gz
    # cd opennebula/
...
Carefully replace the following occurrences with
  ...
  - ``$OPENNEBULA_IMAGE`` - substitute
    ...
    - for **Enterprise Edition** with ``enterprise.opennebula.io/opennebula:6.1.90``
    - for **Community Edition** with ``docker.io/opennebula/opennebula:6.1.90``
