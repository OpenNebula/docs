...
.. prompt:: bash # auto
    ...
    # docker pull enterprise.opennebula.io/opennebula:6.0.2
...
.. prompt:: bash # auto
    ...
    # docker pull docker.io/opennebula/opennebula:6.0.0.2
...
.. prompt:: bash # auto
    ...
    # wget --user=XXXX --ask-password https://enterprise.opennebula.io/packages/opennebula-6.0.2/container/docker-compose-opennebula.tar.gz
...
Carefully replace the following occurrences with
  ...
  - ``$OPENNEBULA_IMAGE`` - substitute
    ...
    - for **Enterprise Edition** with ``enterprise.opennebula.io/opennebula:6.0.2``
    - for **Community Edition** with ``docker.io/opennebula/opennebula:6.0.0.2``
