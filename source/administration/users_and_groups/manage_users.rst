...
OpenNebula supports user accounts and groups. This guide shows how to manage users. To manage user rights, visit the :ref:`Managing ACL Rules <manage_acl>` guide.
