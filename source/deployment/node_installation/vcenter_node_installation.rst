...
* On the public download server. In a case of installation problems,
  ...
  * https://downloads.opennebula.org/packages/opennebula-5.10.0/fw-vnc-5.10.0.vib
  * https://downloads.opennebula.org/packages/opennebula-5.10.0/fw-vnc-5.10.0.zip
...
.. prompt:: bash $ auto
    ...
    $ esxcli <connection options> software vib install -v 'https://downloads.opennebula.org/packages/opennebula-5.10.0/fw-vnc-5.10.0.vib'
