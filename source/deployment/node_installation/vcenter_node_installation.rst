...
* On public download server. In a case of installation problems,
  ...
  * https://downloads.opennebula.org/packages/opennebula-5.7.85/fw-vnc-5.7.85.vib
  * https://downloads.opennebula.org/packages/opennebula-5.7.85/fw-vnc-5.7.85.zip
...
.. prompt:: bash $ auto
    ...
    $ esxcli <connection options> software vib install -v 'https://downloads.opennebula.org/packages/opennebula-5.7.85/fw-vnc-5.7.85.vib'
