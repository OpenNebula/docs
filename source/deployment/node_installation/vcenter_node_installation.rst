...
* On public download server. In a case of installation problems,
  ...
  * https://downloads.opennebula.org/packages/opennebula-5.6.1/fw-vnc-5.6.1.vib
  * https://downloads.opennebula.org/packages/opennebula-5.6.1/fw-vnc-5.6.1.zip
...
.. prompt:: bash $ auto
    ...
    $ esxcli <connection options> software vib install -v 'https://downloads.opennebula.org/packages/opennebula-5.6.1/fw-vnc-5.6.1.vib'
