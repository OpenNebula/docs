...
* On public download server. In a case of installation problems,
  ...
  * https://downloads.opennebula.org/packages/opennebula-5.9.90/fw-vnc-5.9.90.vib
  * https://downloads.opennebula.org/packages/opennebula-5.9.90/fw-vnc-5.9.90.zip
...
.. prompt:: bash $ auto
    ...
    $ esxcli <connection options> software vib install -v 'https://downloads.opennebula.org/packages/opennebula-5.9.90/fw-vnc-5.9.90.vib'
