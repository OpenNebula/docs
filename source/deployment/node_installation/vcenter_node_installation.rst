...
* On the public download server. In a case of installation problems,
  ...
  * https://downloads.opennebula.io/packages/opennebula-5.12.0/fw-vnc-5.12.0.vib
  * https://downloads.opennebula.io/packages/opennebula-5.12.0/fw-vnc-5.12.0.zip
...
.. prompt:: bash $ auto
    ...
    $ esxcli <connection options> software vib install -v 'https://downloads.opennebula.io/packages/opennebula-5.12.0/fw-vnc-5.12.0.vib'
