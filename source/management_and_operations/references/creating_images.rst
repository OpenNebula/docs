...
.. prompt:: bash $ auto
   :substitutions:
    ...
    $ mkdir packages
    $ cd packages
    $ wget https://github.com/OpenNebula/addon-context-linux/releases/download/v|version|/one-context-|version|-1.el6.noarch.rpm
    $ wget https://github.com/OpenNebula/addon-context-linux/releases/download/v|version|/one-context-|version|-1.el7.noarch.rpm
    $ wget https://github.com/OpenNebula/addon-context-linux/releases/download/v|version|/one-context-|version|-1.el8.noarch.rpm
    $ wget https://github.com/OpenNebula/addon-context-linux/releases/download/v|version|/one-context-|version|-1.suse.noarch.rpm
    $ wget https://github.com/OpenNebula/addon-context-linux/releases/download/v|version|/one-context-|version|-alt1.noarch.rpm
    $ wget https://github.com/OpenNebula/addon-context-linux/releases/download/v|version|/one-context_|version|-1.deb
    $ wget https://github.com/OpenNebula/addon-context-linux/releases/download/v|version|/one-context-|version|-r1.apk
    $ wget https://github.com/OpenNebula/addon-context-linux/releases/download/v|version|/one-context-|version|_1.txz
    $ cd ..
