...
To use Q-in-Q in an Open vSwitch network simply add CVLANS attribute with list of VLAN ID's:
...
.. code::
    ...
    CVLANS   = "1,3,5,10-12"      # "customer" VLAN ID's
    ...

As result after VM creation you can check that ``cvlans`` is set to the Open vSwitch port:
