...
.. todo:: Review all guides and add vCenter references. To discuss: do we need host template reference? datastore reference? public_cloud reference vcenter, ec2, azure?

How Should I Read This Chapter
================================================================================

After reviewing and understanding the contents of the :ref:`operation guide <_operation_guide>` pertinent to your particular cloud infrastructure, you can use this reference Sections to look for the meaning of particular attributes that may be interesting to fine tune the behavior of different resources.
