...
.. prompt:: bash $ auto
    ...
    $ mkdir packages
    $ cd packages
    $ wget https://github.com/OpenNebula/addon-context-linux/releases/download/v5.11.80/one-context-5.11.80-1.el6.noarch.rpm
    $ wget https://github.com/OpenNebula/addon-context-linux/releases/download/v5.11.80/one-context-5.11.80-1.el7.noarch.rpm
    $ wget https://github.com/OpenNebula/addon-context-linux/releases/download/v5.11.80/one-context-5.11.80-1.el8.noarch.rpm
    $ wget https://github.com/OpenNebula/addon-context-linux/releases/download/v5.11.80/one-context-5.11.80-1.suse.noarch.rpm
    $ wget https://github.com/OpenNebula/addon-context-linux/releases/download/v5.11.80/one-context_5.11.80-1.deb
    $ wget https://github.com/OpenNebula/addon-context-linux/releases/download/v5.11.80/one-context-5.11.80-r1.apk
    $ wget https://github.com/OpenNebula/addon-context-linux/releases/download/v5.11.80/one-context-5.11.80_1.txz
    $ cd ..
