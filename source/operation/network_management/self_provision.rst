...
Virtual Network Templates allow users to create their own network without knowledge of the underlying infrastructure. Virtual Network Templates allows end user to set the logic attributes, like address ranges, dns server, gateway, etc, of the network as needed. All the information about Virtual Network Templates is available :ref:`here <vn_templates>`.