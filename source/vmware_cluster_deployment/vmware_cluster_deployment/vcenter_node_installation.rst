...
* On the public download server. In a case of installation problems,
  ...
  * https://downloads.opennebula.io/packages/opennebula-6.3.80/fw-vnc-6.3.80.vib
  * https://downloads.opennebula.io/packages/opennebula-6.3.80/fw-vnc-6.3.80.zip
...
.. prompt:: bash $ auto
    ...
    $ esxcli <connection options> software vib install -v 'https://downloads.opennebula.io/packages/opennebula-6.3.80/fw-vnc-6.3.80.vib'
