...
You can consult the `doc online </doc/5.8/oca/python/>`__, but as long as the code is generated it is not much useful, the main source of the documentation is still the `XML-RPC doc <api>`
