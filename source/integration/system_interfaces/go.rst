...
|   Resource           | URL                                                                                                    |
+======================+========================================================================================================+
| Marketplace          | http://docs.opennebula.org/5.7/integration/system_interfaces/api.html#onemarket                        |
+----------------------+--------------------------------------------------------------------------------------------------------+
| Marketapp            | http://docs.opennebula.org/5.7/integration/system_interfaces/api.html#onemarketapp                     |
+----------------------+--------------------------------------------------------------------------------------------------------+
| Security Groups      | http://docs.opennebula.org/5.7/integration/system_interfaces/api.html#onesecgroup                      |
+----------------------+--------------------------------------------------------------------------------------------------------+
| VM Groups            | http://docs.opennebula.org/5.7/integration/system_interfaces/api.html#onevmgroup                       |
+----------------------+--------------------------------------------------------------------------------------------------------+
| Virtual Router       | http://docs.opennebula.org/5.7/integration/system_interfaces/api.html#onevrouter                       |
+----------------------+--------------------------------------------------------------------------------------------------------+
