...
Features for network extension model refined in OpenNebula 4.10 were funded by `BlackBerry <http://global.blackberry.com/es.html>`__ in the context of the Fund a Feature Program.
