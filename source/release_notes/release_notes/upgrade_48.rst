...
Read the Compatibility Guide for `4.10 <http://docs.opennebula.org/4.10/reLease_noTes/release_notes/compatibility.html>`_ and :ref:`4.12 <compatibility>`, and the `Release Notes <http://opennebula.org/software/release/>`_ to know what is new in OpenNebula 4.12.

Upgrading a Federation
================================================================================

If you have two or more 4.8 OpenNebulas working as a :ref:`Federation <introf>`, you can upgrade each one independently. Zones with 4.8 and 4.12 OpenNebulas can be part of the same federation, with a caveat: Security Groups.
