...
-  Install context packages with one of these methods:
   ...
   -  Download and install the package for your distribution:
      ...
      -  `DEB <http://dev.opennebula.org/attachments/download/797/one-context_4.7.1.deb>`__: Compatible with Ubuntu 11.10 to 14.04 and Debian 6/7
      -  `RPM <http://dev.opennebula.org/attachments/download/796/one-context_4.7.1.rpm>`__: Compatible with CentOS and RHEL 6/7
