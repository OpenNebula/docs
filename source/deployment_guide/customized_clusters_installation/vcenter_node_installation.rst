...
* On the public download server. In a case of installation problems,
  ...
  * https://downloads.opennebula.io/packages/opennebula-5.13.80/fw-vnc-5.13.80.vib
  * https://downloads.opennebula.io/packages/opennebula-5.13.80/fw-vnc-5.13.80.zip
...
.. prompt:: bash $ auto
    ...
    $ esxcli <connection options> software vib install -v 'https://downloads.opennebula.io/packages/opennebula-5.13.80/fw-vnc-5.13.80.vib'
