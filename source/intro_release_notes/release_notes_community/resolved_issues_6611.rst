.. _resolved_issues_6611:

Resolved Issues in 6.6.1.1
--------------------------------------------------------------------------------

OpenNebula 6.6.1.1 adds :ref:`migrators to 6.6 from any previous version <upgrade_single>`.

The following new features has been backported to 6.6.1.1:
...
The following issues has been solved in 6.6.1.1:
