...
.. If you are upgrading from a 6.0.x installation you only need to follow a reduced set of steps.

.. note::

   If you are running a 5.8.x version or older, please check :ref:`for additional steps <older_versions_upgrade>`.
...
.. prompt:: text # auto
     ...
     ANY   : Configuration updated to 6.4.0
