...
- `Add Default Zone Endpoint for users <https://github.com/OpenNebula/one/issues/3335>`__.
...
- `Fix Updating vCenter VM disk image in Sunstone does not remove OPENNEBULA_MANAGED attribute <https://github.com/OpenNebula/one/issues/3195>`__.
