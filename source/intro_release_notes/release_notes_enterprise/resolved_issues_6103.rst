...
- `Fix Add PCI tab when instantiate a vm <https://github.com/OpenNebula/one/issues/6799>`__. In order to activate the PCI tab, please see **Changes in Configuration Files** section below.
